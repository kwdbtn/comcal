    ...
    <div class="row justified-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4>
                        <strong>{{ $usergroup->exists ? "Editing '".$usergroup->name."'" : "New user group" }}</strong>
                        <span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 col-md-8">
                            ...
                            ','placeholder'=>'User group', 'required']) !!}
                        </div>
                    </div>

                    <div class="form-group row mt-1">
                        {!! Form::label('user_id', 'Users:', ['class' => 'control-label col-sm-2 text-end']) !!}
                            <div class="col-sm-8">
